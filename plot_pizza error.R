...
Data from StatsBomb via FBref. Inspired by @Worville. Created using ggshakeR."
    ...
    ggplot(data_selected, aes(fct_reorder(Statistic, stat), Percentile)) +
      ...
      geom_hline(yintercept = 25, colour = colorLine, linetype = "dashed", alpha = 1) +
      geom_hline(yintercept = 50, colour = colorLine, linetype = "dashed", alpha = 1)+
      geom_hline(yintercept = 75, colour = colorLine, linetype = "dashed", alpha = 1)+
